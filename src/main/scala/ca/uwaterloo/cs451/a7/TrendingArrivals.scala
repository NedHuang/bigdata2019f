...
object TrendingArrivals {
  ...
  def main(argv: Array[String]): Unit = {
    ...
    val goldman_longitude_max =  goldman_longitude.max
    val goldman_longitude_min = goldman_longitude.min
    val goldman_latitude_max = goldman_latitude.max
    val goldman_latitude_min = goldman_latitude.min
    ...
    val citigroup_longitude_max =  citigroup_longitude.max
    val citigroup_longitude_min = citigroup_longitude.min
    val citigroup_latitude_max = citigroup_latitude.max
    val citigroup_latitude_min = citigroup_latitude.min
    ...
    val wc = stream.map(_.split(","))
      ...
      .filter(line => 
        ((line._1 > goldman_longitude_min) && (line._1 < goldman_longitude_max) && (line._2 > goldman_latitude_min) && (line._2 < goldman_latitude_max))
        ||
        ((line._1 > citigroup_longitude_min) && (line._1 < citigroup_longitude_max) && (line._2 > citigroup_latitude_min) && (line._2 < citigroup_latitude_max))
      )
      .map(line => {
          if((line._1 > goldman_longitude_min) && (line._1 < goldman_longitude_max) && (line._2 > goldman_latitude_min) && (line._2 < goldman_latitude_max)){
              ("goldman", 1)
          }else{
              ("citigroup", 1)
          }
